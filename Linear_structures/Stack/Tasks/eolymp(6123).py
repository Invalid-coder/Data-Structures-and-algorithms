#https://www.e-olymp.com/uk/submissions/7375236
...
class Stack():
    ...
    def back(self): return self.items[-1] if not self.empty() else 'error'
    def pop(self): return self.items.pop() if not self.empty() else 'error'
